...
1. Download, install and launch [MeshMC](https://projecttick.org/)
...
5. Search for "MeshMC" and tap `Install` on the first result.
6. Launch it and go through its initial setup process, then close it.
7. Open Steam app, select `Games` → `Add a Non-Steam Game to My Library...` → select MeshMC → `ADD SELECTED PROGRAMS`.
8. Close Steam and launch `Return to Gaming Mode`.
9. Launch MeshMC from your game library.
10. Tap `Add Instance`
