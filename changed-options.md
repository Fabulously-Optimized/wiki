...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| autoJump                    | Makes the player jump when approaching a 1-height block                                                                                                                                               | true     | false   | Many people consider it annoying and therefore disable it (1.19.4 parity)                                                                                   |
| snooperEnabled              | Toggles [Snooper](https://minecraft.fandom.com/wiki/Snooper), a hardware analytics service. The setting was removed in 1.13 but it still exists in options (and defaults to enabled) for some reason. | true     | false   | Just in case you use the same profile on MC 1.13 or older, to improve privacy. In 1.18+ [Debugify](https://curseforge.com/minecraft/mc-mods/debugify) is used to disable the new telemetry. |
...
| chatPreview                 | Whether to display the [Chat Preview](https://minecraft.fandom.com/wiki/Java_Edition_22w19a#General) toolbar                                                                                          | 1     | 0   | Disabled for privacy to avoid sending your chat to the server as you type, avoids related annoyances like toasts and warnings, 1.19.3 parity                        |
...
The changed mod settings can be found on the repo at [.../yosbr/1.19.2/config](https://github.com/Fabulously-Optimized/fabulously-optimized/tree/main/Packwiz/1.19.2/config).
...
| ----------------------------------------------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [MC-26757](https://bugs.mojang.com/browse/MC-26757)   | Large item tooltips can get cut off at the edges of the screen             | [Debugify](https://curseforge.com/minecraft/mc-mods/debugify)     |
