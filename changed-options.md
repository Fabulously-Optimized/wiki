...
| skipMultiplayerWarning      | Whether to skip [the legal disclaimer](https://minecraft.wiki/w/File:Multiplayer\_disclaimer.png) when opening the multiplayer screen               | false    | true    | I expect my users to already know that the third party servers are not owned or monitored by Mojang Studios or Microsoft. A more relevant warning is added to Realms by [No Chat Reports](https://www.curseforge.com/minecraft/mc-mods/no-chat-reports). |
