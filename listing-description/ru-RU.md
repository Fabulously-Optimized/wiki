...
Fabulously Optimized не включает в себя никаких контентных модов, поэтому работает в любом мире и на любом сервере. Также он [запускается в 4 лаунчерах, размещён на 3 сайтах][6] и [переведён на многие языки][7], включая Русский.
