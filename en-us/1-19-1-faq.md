...
- If you see a yellow ℹ️ near chatbox, you are likely safe even if others report you. However, other players will see red markings near your messages and if they enable the vanilla "Only Show Secure Chat" option, they won't see your chat messages at all.
  - Unfortunately that is what most 1.19+ servers will see, even if they have chat reporting disabled by the server. In the future NCR may be able to show the green checkmark in more cases, but right now you can ask your server admins on whether the server has additional protections in place.
