...
* **Banned from all multiplayer** - instead of getting punished on one server, you are getting punished on all, including Realms and others' LAN servers. Maybe you got angry on one server and want to go to another to relax again? Nope, cannot do that.

* **Realms subscriptions don't get cancelled** - if you get banned, Mojang will not automatically cancel any Realms servers you own, meaning you'll pay for server(s) you cannot access or control.

* **Not sent to server admins** - this system would be great if the reports were sent to server admins, it could create a truly consistent way of reporting players in all servers. Sending reports to Mojang will result in different judgement and outcomes of the cases - while server admins could punish faster, with a shorter penalty, with different kinds of punishments like mutes and jails, Mojang can only ban people from the entirety of multiplayer or not punish at all.
