...
This is a non-conclusive list. People have voiced their concerns in various Minecraft communities and the feedback site, search around.
...
- If you see a yellow ℹ️ near chatbox, you are likely safe even if others report you. However, other players will see red markings near your messages and if they enable the vanilla "Only Show Secure Chat" option, they won't see your chat messages at all.
  - Unfortunately that is what most 1.19+ servers will see, even if they have plugins to disable chat reporting server-side. In the future NCR may be able to communicate with those plugins to get the accurate icon.
...
This is a non-conclusive list. People have voiced their ideas in various Minecraft communities and the feedback site, search around.
