...
* **Sent to Microsoft instead of server admins** - this system would be great if the reports were sent to server admins, it could create a truly consistent way of reporting players in all servers. Sending reports to Mojang will result in different judgement and outcomes of the cases - while server admins could punish faster, with a shorter penalty, with different kinds of punishments like mutes and jails, Mojang can only ban people from the entirety of multiplayer.
