...
* **Lack of context** - Players can select _one to four_ messages, to which the system will add up to 6 messages before and after the selected ones. That is a lot less context than player builds, signs, Discord/forum messages, daily general behavior etc.
