...
The report button itself still works on servers that _force_ reporting (others can report you too). Please use it only in case of serious danger and even then don't forget to inform the server admins and, if needed, the local police.
