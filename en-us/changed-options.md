...
| advancedItemTooltips                | Enables "debugging" tooltip rows on items - item ID and durability                                                                                                               | false    | true    | These are useful for much more than just "debugging" - using any commands, getting exact durability value, learning English, etc.                                                               |
