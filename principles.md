...
* **Privacy** - you shall not be punished for "having too many mods" or "using the wrong zoom mod". In simpler terms, the client tells as little about itself to the servers as possible, even though the mods already respect most servers' rules.
