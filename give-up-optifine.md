...
One of the goals of Fabulously Optimized is to provide feature parity with [OptiFine](https://optifine.net/home), in order to make it easier for users to transition away from it. So, all you need to do is to [install Fabulously Optimized](install-instructions/) to get all those mods at once!
...
| HD Fonts                                     | ✔️            | [Possible in vanilla since 1.13](https://minecraft.wiki/w/Java_Edition_1.13-pre6#Changes) [(Download some from author's profile)](https://www.curseforge.com/members/robotkoer/projects)                                                            |
...
1. [Disable MoreCulling](disabling-mods/)
2. [Install](adding-more-mods/) the original [Cull Leaves](https://www.curseforge.com/minecraft/mc-mods/cull-leaves)
...
³ Sodium, which is the mod providing a more performant rendering engine also has a redesigned video settings screen. This is persisted in the modpack, as users consider it to be more organized and better-looking than the vanilla one. Additionally, it adds new and hides some vanilla options that reflect the changed engine more accordingly.
