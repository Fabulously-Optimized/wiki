...
{% hint style="warning" %} Never unlink the instance, it just prevents you from updating the modpack later. If you already did it, make a new instance and copy your content over. {% endhint %}
