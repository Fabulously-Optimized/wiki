...
2. **For 4.8.0-4.x.x**: Download [this version of Sodium](https://modrinth.com/mod/sodium/version/mc1.19.4-0.4.10)
...
9. **For 4.8.0-4.x.x**: Copy downloaded Sodium JAR to _mods_ folder
