...
How to [⬇️ Install](install-instructions/README.md) | [🆕 Update](update-instructions/README.md) [(reset options)](update-instructions/resetting-options.md) | [➕ Add mods](adding-more-mods.md) | [➖ Remove mods](disabling-mods.md) | [🗑️ Backup and uninstall](backup-and-uninstall.md)
