...
*   FO disables the third-party server disclaimer shown when using the multiplayer function for the first time. By using FO, YOU also agree to the following disclaimer: <img src="https://minecraft.wiki/images/Multiplayer_disclaimer.png" alt="Screenshot of the third-party server disclaimer" data-size="original">
